...
| メンバー     | イメージカラー   | キャッチフレーズ     | おともだち         |
| ------------ | ---------------- | -------------------- | ------------------ |
| ドズル       | 赤 `#E53935`     | ロジカルゴリラ社長   | ビッグボス         |
| ぼんじゅうる | 紫 `#7B1FA2`     | （心やさしい）卑怯者 | グラサンバード     |
| おんりー     | 黄色 `#FDD835`   | スピードスター       | いなりー（キツネ） |
| おらふくん   | 水色 `#0097A7`   | あなたの心を狙い撃ち | 雪だるまくん       |
| おおはらMEN  | ピンク `#E91E8C` | ズボラな匠           | —                  |
