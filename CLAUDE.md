...
| --- | --- | --- | --- | --- | --- |
| STAGE 1 | `zombie` | ゾンビ（初級） | 草原・村の夜 | 〜4文字 | 1.5秒 |
| STAGE 2 | `drowned` | ドラウンド（中級） | 海・川 | 4〜6文字 | 1.3秒 |
| STAGE 3 | `wither-skeleton` | ウィザスケ（上級） | ネザー要塞 | 6〜8文字 | 1.1秒 |
| STAGE 4 | `shulker` | シュルカー（超上級） | エンドシティ | 8〜10文字 | 0.9秒 |
| STAGE 5 | `ender-dragon` | エンドラ（BOSS） | ジ・エンド | 10〜12文字 | 0.8秒 |
| EXTRA | `dozle-battle` | ドズル社 | ドズル社HQ | 12〜15文字 | 0.7秒 |
