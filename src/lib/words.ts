...
import type { StageConfig, WordEntry } from "@/types";

/**
 * ドズル社モード専用ワードプール。
 * 各難易度の「ドズル社関連」コメントセクションのワードをすべて収録する。
 */
export const DOZLE_WORDS: WordEntry[] = [
  // ── cheat 由来（ドズル社関連 短いもの）────────────────────
  { display: "ドズル", reading: "どずる" },
  { display: "おんりー", reading: "おんりー" },
  { display: "ドズル社", reading: "どずるしゃ" },
  { display: "いなりー", reading: "いなりー" },
  // ── cheat 由来（ドズル社関連 新規追加）──────────────────────
  ...
  { display: "スピードスター", reading: "すぴーどすたー" },
  { display: "ズボラな匠", reading: "ずぼらなたくみ" },
  { display: "グラサンバード", reading: "ぐらさんばーど" },
  { display: "雪だるまくん", reading: "ゆきだるまくん" },
  { display: "おおはらMEN", reading: "おおはらMEN" },
  // ── normal 由来（ドズル社関連 新規追加）──────────────────────
  ...
  // ── hard 由来（ドズル社関連 新規追加）───────────────────────
  { display: "じゃじゃーんすっぞ", reading: "じゃじゃーんすっぞ" },
  { display: "改造ファンカーゴ", reading: "かいぞうふぁんかーご" },
  { display: "ベットベットパタパッタ", reading: "べっとべっとぱたぱった" },
  { display: "ロジカルゴリラ社長", reading: "ろじかるごりらしゃちょう" },
  { display: "誰でもできますねぇ", reading: "だれでもできますねぇ" },
  { display: "ちょいちょいクラロワ", reading: "ちょいちょいくらろわ" },
  { display: "ドズル・ゴリラ・ゴリラ・ドズル", reading: "どずる/ごりら/ごりら/どずる" },
  { display: "高圧洗浄", reading: "こうあつせんじょう" },
  { display: "俺じゃなきゃ死んでたぞ", reading: "おれじゃなきゃしんでたぞ" },
  { display: "無敵のぼんじゅうる", reading: "むてきのぼんじゅうる" },
  { display: "ドズンゲリオン 発進!", reading: "どずんげりおんはっしん!" },
  { display: "お嬢様鬼ごっこ", reading: "おじょうさまおにごっこ" },
  { display: "こ、この声は神様!", reading: "こ,このこえはかみさま!" },
  { display: "クッキークリッカー", reading: "くっきーくりっかー" },
  { display: "おデブに感謝しな", reading: "おでぶにかんしゃしな" },
  { display: "ネザー生まれエンド育ち", reading: "ねざーうまれえんどそだち" },
  { display: "マイクラバーサス無双MVP", reading: "まいくらばーさすむそうMVP" },
  { display: "俺だったら死んでたぞ", reading: "おれだったらしんでたぞ" },
  { display: "モツですホルモンです", reading: "もつですほるもんです" },
  { display: "カロリー爆弾喰らえ!", reading: "かろりーばくだんくらえ!" },
  { display: "小太り三人衆", reading: "こぶとりさんにんしゅう" },
  { display: "大富豪おじいちゃん", reading: "だいふごうおじいちゃん" },
  { display: "プロマインクラフター", reading: "ぷろまいんくらふたー" },
  { display: "今回の骸は!", reading: "こんかいのむくろは!" },
  { display: "ハムスター先輩", reading: "はむすたーせんぱい" },
  { display: "凡人かぼんじゅうるか", reading: "ぼんじんかぼんじゅうるか" },
  { display: "ヘッドにキャロット", reading: "へっどにきゃろっと" },
  { display: "不死的ピョン人形", reading: "ふしてきぴょんにんぎょう" },
  { display: "ちょろちょろドズル", reading: "ちょろちょろどずる" },
  { display: "ドズル社スクランブル", reading: "どずるしゃすくらんぶる" },
  { display: "自由の中の不自由", reading: "じゆうのなかのふじゆう" },
  { display: "龍の尻尾みたい!", reading: "りゅうのしっぽみたい!" },
  { display: "恋愛はパチンコ", reading: "れんあいはぱちんこ" },
  { display: "おらふくんは悪くないよ", reading: "おらふくんはわるくないよ" },
  { display: "ひまわり耐久", reading: "ひまわりたいきゅう" },
  { display: "ドズル社最高!", reading: "どずるしゃさいこう!" },
  { display: "全肯定男の子", reading: "ぜんこうていおとこのこ" },
  { display: "マイゴット少年", reading: "まいごっとしょうねん" },
  { display: "かずのこ大好きマン", reading: "かずのこだいすきまん" },
  { display: "セミさんが永ミーン", reading: "せみさんがえいみーん" },
  { display: "おじさん間引き事件", reading: "おじさんまびきじけん" },
  { display: "ノンデリおらふくん", reading: "のんでりおらふくん" },
  { display: "ひみつのしーでござるよ", reading: "ひみつのしーでござるよ" },
  { display: "ぼんさん何してんすか", reading: "ぼんさんなにしてんすか" },
  { display: "切り抜きかもわからん", reading: "きりぬきかもわからん" },
  { display: "誰でも見れますねぇ", reading: "だれでもみれますねえ" },
  // ── kichiku 由来（全ワード）────────────────────────────────
  { display: "(心やさしい)卑怯者", reading: "(こころやさしい)ひきょうもの" },
  { display: "あなたの心を狙い撃ち", reading: "あなたのこころをねらいうち" },
  { display: "これがドズル社の力だ", reading: "これがどずるしゃのちからだ" },
  { display: "マインクラフトは人生だ", reading: "まいんくらふとはじんせいだ" },
  { display: "ドズル社の動画をみてくれ", reading: "どずるしゃのどうがをみてくれ" },
  { display: "おんりーのスピードはまじやばい", reading: "おんりーのすぴーどはまじやばい" },
  { display: "おおはらMENの匠の技をみよ", reading: "おおはらMENのたくみわざをみよ" },
  { display: "全員集合!ドズル社の時間だ!", reading: "ぜんいんしゅうごう!どずるしゃのじかんだ!" },
  { display: "おらふくんの雪だるまがかわいすぎる", reading: "おらふくんのゆきだるまがかわいすぎる" },
  { display: "ぼんじゅうるは卑怯だけど心はやさしい", reading: "ぼんじゅうるはひきょうだけどこころはやさしい" },
  { display: "おんりー100万人達成", reading: "おんりー100まんにんたっせい" },
  { display: "お前牛乳俺ダイヤ", reading: "おまえぎゅうにゅうおれだいや" },
  { display: "拙者そんなものには媚びん!", reading: "せっしゃそんなものにはこびん!" },
  { display: "俺の引越しセンター返せよ!", reading: "おれのひっこしせんたーかえせよ!" },
  { display: "一旦八本一旦木綿", reading: "いったんはっぽんいったんもめん" },
  { display: "これね、ミキプルーンの苗木", reading: "これね,みきぷるーんのなえぎ" },
  { display: "チューリップを抜いたからには命をかけろよ", reading: "ちゅーりっぷをぬいたからにはいのちをかけろよ" },
  { display: "エンドラの首は俺のもんだぁ!", reading: "えんどらのくびはおれのもんだぁ!" },
  { display: "ってドズルさんが言ってました", reading: "ってどずるさんがいってました" },
  { display: "焦げじゃねぇブリュレって呼べ", reading: "こげじゃねぇぶりゅれってよべ" },
  { display: "今日もマッチョが売れないわ", reading: "きょうもまっちょがうれないわ" },
  { display: "ちょっとした重大発表", reading: "ちょっとしたじゅうだいはっぴょう" },
  { display: "手持ちは少なく心は広く", reading: "てもちはすくなくこころはひろく" },
  { display: "いつものことじゃないですか", reading: "いつものことじゃないですか" },
  { display: "ドズル社カスタマーサポートです", reading: "どずるしゃかすたまーさぽーとです" },
  { display: "マリーザ生きててくれてありがとう", reading: "まりーざいきててくれてありがとう" },
  { display: "エンドラ倒す方が簡単じゃない？", reading: "えんどらたおすほうがかんたんじゃない?" },
  { display: "空気清浄機ウィーン!", reading: "くうきせいじょうきうぃーん!" },
  { display: "地球だってちょっと楕円だから", reading: "ちきゅうだってちょっとだえんだから" },
  { display: "チームの失敗は成長に繋がらない", reading: "ちーむのしっぱいはせいちょうにつながらない" },
  { display: "僕はあなたのお母さんではありませんよ!", reading: "ぼくはあなたのおかあさんではありませんよ!" },
  { display: "こいつの性格終わってやがる!", reading: "こいつのせいかくおわってやがる!" },
  { display: "配信界の下ネタ自動販売機", reading: "はいしんかいのしもねたじどうはんばいき" },
  { display: "あなたがいるところが中心", reading: "あなたがいるところがちゅうしん" },
  { display: "安心安全信頼実績 預けるだけで幸福を", reading: "あんしんあんぜんしんらいじっせきあずけるだけでこうふくを" },
  { display: "お前遊びとちゃうぞ真剣にやれよ", reading: "おまえあそびとちゃうぞしんけんにやれよ" },
  { display: "抱いた事ねえだろ、ドズルをよ", reading: "だいたことねえだろ,どずるをよ" },
  { display: "パスポートの有効期限切れてました", reading: "ぱすぽーとのゆうこうきげんきれてました" },
  { display: "セミと雪女のラブロマンスやめて", reading: "せみとゆきおんなのらぶろまんすやめて" },
  { display: "ぼんじゅうるぼんじゅうるだどーもです", reading: "ぼんじゅうるぼんじゅうるだどーもです" },
  { display: "はーいおつです、おおはらです", reading: "はーいおつです,おおはらです" },
];
...
export const STAGES: StageConfig[] = [
  ...
  // ──────────────────────────────────────────
  // ドズル社モード（文字数制限なし・ワード制限時間なし・180 秒）
  // ──────────────────────────────────────────
  {
    id: "dozle",
    name: "ドズル社モード",
